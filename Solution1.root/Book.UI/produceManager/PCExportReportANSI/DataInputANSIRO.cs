...
namespace Book.UI.produceManager.PCExportReportANSI
{
    public partial class DataInputANSIRO : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public DataInputANSIRO(Model.PCDataInput pcDataInput, Model.PCExportReportANSI pcExportReportANSI)
            : this()
        {
            if (pcDataInput == null)
                return;
            ...
            if (pcExportReportANSI != null)
                this.xrSubreportANSI.ReportSource = new RO(pcExportReportANSI, 0);
